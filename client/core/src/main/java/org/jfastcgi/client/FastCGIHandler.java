...
public class FastCGIHandler {
	...
	public void service(RequestAdapter request, ResponseAdapter response) throws IOException {
		...
		ISocket fcgiSocket = connectionFactory.getConnection();
	...
	private boolean handleRequest(RequestAdapter req, ResponseAdapter res, ISocket fcgiSocket, OutputStream out,
	...
	static class FastCGIInputStream extends InputStream {
		...
		public FastCGIInputStream(ISocket fcgiSocket) throws IOException {
			init(fcgiSocket);
		}

		public void init(ISocket fcgiSocket) throws IOException {
