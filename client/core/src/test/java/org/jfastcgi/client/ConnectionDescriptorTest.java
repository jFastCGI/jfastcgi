...
public class ConnectionDescriptorTest {
	...
	public void testMakeConnDesc_unixSock() {
		final ConnectionDescriptor desc = ConnectionDescriptor.makeConnDesc("unix://var/run/application.sock");
	...
	public void testMakeConnDesc_localhost_port1() throws Exception {
		final TcpConnectionDescriptor desc = (TcpConnectionDescriptor) ConnectionDescriptor.makeConnDesc("localhost:1");
	...
	public void testMakeConnDesc_127001_9000() throws Exception {
		final TcpConnectionDescriptor desc = (TcpConnectionDescriptor) ConnectionDescriptor.makeConnDesc("127.0.0.1:9000");
		assertThat(desc).isNotNull();
		assertThat(desc.getAddr().isReachable(1)).isTrue();
	...
	public void testMakeConnDesc_ipv6_fullAddress() throws Exception {
		final TcpConnectionDescriptor desc = (TcpConnectionDescriptor) ConnectionDescriptor.makeConnDesc("[0:0:0:0:0:0:0:1]:9000");
		assertThat(desc).isNotNull();
		assertThat(desc.getAddr().isReachable(1)).isTrue();
		assertThat(desc.getPort()).isEqualTo(9000);
	}
	...
	public void testMakeConnDesc_ipv6_localhostShortcut() throws Exception {
		final TcpConnectionDescriptor desc = (TcpConnectionDescriptor) ConnectionDescriptor.makeConnDesc("[::1]:9000");
		assertThat(desc).isNotNull();
		assertThat(desc.getAddr().isReachable(1)).isTrue();
		assertThat(desc.getPort()).isEqualTo(9000);
	}
	...
	public void testMakeConnDesc_ipv6_arbitraryAddress() throws Exception {
		final TcpConnectionDescriptor desc = (TcpConnectionDescriptor) ConnectionDescriptor.makeConnDesc("[0000:0000:0000:0000:0000:0acf:0000:0001]:9000");
		assertThat(desc).isNotNull();
	...
	public void testMakeConnDesc_ipv6_invalidAddress() throws Exception {
		ConnectionDescriptor.makeConnDesc("[0000:0Z00:0000:0000:0000:0acf:0000:0001]:9000");
	}
